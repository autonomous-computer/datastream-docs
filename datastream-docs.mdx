...
<CardGroup cols={2}>
  ...
  <Card title="Investor intelligence recovery" icon="shield-check" href="/investor-intelligence-recovery">
    See which one-API investor-agent workflows are already live, which are partial, and how the recovery program is closing the remaining gaps.
  </Card>
</CardGroup>
