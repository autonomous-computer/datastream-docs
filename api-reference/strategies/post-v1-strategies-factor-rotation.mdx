...
description: "Factor rotation scenarios"
---
...
<Prompt>
Use SEC API POST /v1/strategies/factor-rotation to factor rotation scenarios. Preserve `requestId`, `traceparent` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
