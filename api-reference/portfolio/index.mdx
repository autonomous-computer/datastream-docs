...
<Card title="GET /v1/portfolio/stress-test/scenarios" href="/api-reference/portfolio/get-v1-portfolio-stress-test-scenarios">Return the supported portfolio stress-test scenario catalog with macro and factor shock definitions</Card>
</CardGroup>
