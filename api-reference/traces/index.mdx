...
<CardGroup cols={2}>
<Card title="GET /v1/traces" href="/api-reference/traces/get-v1-traces">Batch resolve traces</Card>
<Card title="GET /v1/traces/{trace_id}" href="/api-reference/traces/get-v1-traces-trace-id">Get trace</Card>
</CardGroup>
