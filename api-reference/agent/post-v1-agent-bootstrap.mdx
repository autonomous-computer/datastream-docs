...
description: "Agent bootstrap exchange"
---

Agent bootstrap exchange
...
<Prompt>
Use SEC API POST /v1/agent/bootstrap to agent bootstrap exchange. Preserve `requestId`, `organization`, `apiKey`, `billing`, `limits`, `distribution`, `sponsorToken` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
