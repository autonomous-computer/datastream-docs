...
description: "Factor regime performance"
---
...
<Prompt>
Use SEC API GET /v1/factors/regime-performance to factor regime performance. Preserve `requestId`, `traceparent` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
