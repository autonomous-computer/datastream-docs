...
description: "Thematic similarity pack"
---

Thematic similarity pack
...
<Prompt>
Use SEC API GET /v1/factors/similarity-pack to thematic similarity pack. Preserve `requestId`, `traceparent` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
