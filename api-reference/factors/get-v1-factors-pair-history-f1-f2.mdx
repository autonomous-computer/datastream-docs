...
description: "Factor pair history"
---
...
<Prompt>
Use SEC API GET /v1/factors/pair-history/{f1}/{f2} to factor pair history. Preserve `requestId`, `traceparent` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
