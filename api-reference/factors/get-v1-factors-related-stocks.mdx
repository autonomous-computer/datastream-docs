...
description: "Related stocks by factor"
---

Related stocks by factor
...
<Prompt>
Use SEC API GET /v1/factors/related-stocks to related stocks by factor. Preserve `requestId`, `traceparent` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
