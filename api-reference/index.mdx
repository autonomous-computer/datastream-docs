...
<Card title="Operations" icon="square-stack" href="/api-reference/operations">Reference pages for Operations endpoints.</Card>
...
<Card title="Workbook Installations" icon="square-stack" href="/api-reference/workbook-installations">Reference pages for Workbook Installations endpoints.</Card>
</CardGroup>
