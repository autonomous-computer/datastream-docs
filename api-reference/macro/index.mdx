...
<Card title="GET /v1/macro/status" href="/api-reference/macro/get-v1-macro-status">Return macro runtime readiness, artifact freshness, source posture, and country support status</Card>
</CardGroup>
