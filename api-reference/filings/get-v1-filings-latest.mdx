...
Returns the newest indexed filing for one issuer, and optionally one SEC form, with filing identity, date, accession number, and provenance. Without `form`, the newest record may be any filing type, such as a Form 4 or 8-K; retain the returned accession number for an immutable follow-up.
