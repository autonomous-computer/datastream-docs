...
description: "Enhanced dilution score"
---

Enhanced dilution score
...
<Prompt>
Use SEC API GET /v1/signals/dilution/enhanced to enhanced dilution score. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `score`, `band`, `confidence`, `factors`, `subRatings`, `factorModelContext` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
