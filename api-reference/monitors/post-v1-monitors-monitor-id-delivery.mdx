...
description: "Update monitor delivery"
---

Update monitor delivery
...
<Prompt>
Explain the delivery destination fields and applicable activation requirements, then direct the user to complete the change in the signed-in SEC API dashboard. Preserve the monitor id and returned delivery status for follow-up.
</Prompt>
