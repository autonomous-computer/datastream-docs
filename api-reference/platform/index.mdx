...
<Card title="POST /v1/billing/checkout" href="/api-reference/platform/post-v1-billing-checkout">Create a Stripe Checkout session for a self-serve Pro or Team SEC API plan</Card>
...
<Card title="POST /v1/billing/grant/reset" href="/api-reference/platform/post-v1-billing-grant-reset">Reset free starter allowance usage for the current monthly period, rate-limited to once per rolling 30 days per organization</Card>
...
<Card title="GET /v1/billing/rates" href="/api-reference/platform/get-v1-billing-rates">Return the public pricing catalog, free allowance metadata, plan metadata, and meter-family launch rates</Card>
