...
description: "Company macro exposure"
---

Company macro exposure
...
<Prompt>
Use SEC API GET /v1/companies/macro-exposure to company macro exposure. Preserve `requestId`, `traceparent`, `provenance` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
