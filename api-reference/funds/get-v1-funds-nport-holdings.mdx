...
description: "N-PORT fund holdings"
---
...
<Prompt>
Use SEC API GET /v1/funds/nport/holdings to n-PORT fund holdings. Preserve `requestId`, `traceparent` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
