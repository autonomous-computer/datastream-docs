...
- New organizations receive `100` included calls each month. This free allowance renews automatically.
- Pay As You Go supports uneven or early internal usage without a fixed monthly fee.
- Pro and Team suit sustained in-house use.
...
| --- | --- | --- |
| Free allowance | A bounded evaluation before paid usage. | 100 included calls each month; hard-limited and non-cash. |
| Pay As You Go | Early, uneven, or low-volume internal use. | Metered usage with prepaid credits. |
| Pro | Sustained work by one analyst or developer. | $49/month subscription with $10 included credits, 15% discounted overages, and budget gates. |
| Team | Sustained shared internal work. | $199/month subscription with $50 included credits, 25% discounted overages, and budget gates. |
