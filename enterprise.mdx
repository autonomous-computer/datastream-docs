...
The Team plan (`$199/mo`) supports up to five seats within a shared organization. All seats share:
...
Each plan tier has a key limit. Team plans include more keys than Pro or PAYG:
