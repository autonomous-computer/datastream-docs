...
Replay, endpoint changes, tests, and secret rotation belong in the signed-in dashboard because they are account settings actions. Do not attempt them with an API key or delegate them to an agent.
