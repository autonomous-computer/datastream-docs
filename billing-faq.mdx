...
Yes. Every new organization receives `100` included calls each month. The free allowance renews automatically. `GET /v1/billing` shows the authenticated organization's remaining included usage and current billing state.
...
No. Pay As You Go is the paid path for metered use. Pro and Team are for sustained internal use. Commercial covers external-facing use and negotiated terms. Read [plans and pricing](/plans-and-pricing) before choosing a path.
...
The sandbox grant has 10 AI queries per UTC calendar month. Pay As You Go, Pro, Team, and Commercial are not subject to a fixed monthly AI-query cap; they are metered and governed by their current billing and budget controls.
