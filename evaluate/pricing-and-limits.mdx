...
- New organizations receive `100` included live calls each month. Do not present that allowance as uncapped usage.
...
- Keep API keys server-side or in a client secret facility. Billing-management actions require a signed-in dashboard session.
