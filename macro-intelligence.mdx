...
Cross a single company's geographic revenue segments with country macro data to get revenue-weighted macro sensitivities:
...
For source-level detail, see [Official macro data sources](/macro-tier1).
