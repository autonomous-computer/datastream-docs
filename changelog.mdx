...
<Update label="March 23, 2026" description="factors: wire purified materialization + 50 more" tags={["OMNI", "Release"]}>
Highlights from this shipping window include factors: wire purified materialization; intelligence: compress semantic payloads; intelligence: finish company and portfolio bundles.
...
- intelligence: add cached async query runtime
</Update>
