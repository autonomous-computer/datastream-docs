...
| **Factor count** | ETF-proxy slice | 230+ tracked definitions; a subset is exposed through the API today |
...
Access the 230+ tracked factor-definition catalog with methodology and source-rights metadata. Not every tracked definition is queryable; inspect catalog coverage and freshness metadata before making long-history claims:
