...
| ----------------- | ----------------------------------------------- | -------------------------------------- | ---------------- |
| **Free allowance** | 100 calls/month (renewable hard cap)       | Limited AI questions                   | None             |
| **Pay-as-you-go** | From $0.01/call                                 | n/a                                    | $0.004–$0.019/KB |
| **Pro**            | $49/month + $10 included credits + 15% overage discount | $59/month — 600 AI Q (7-day trial)     | n/a              |
| **Team**           | $199/month + $50 included credits + 25% overage discount | $199/month — 1,000 AI Q (7-day trial)  | n/a              |
...
- SEC API PAYG (300 × $0.01/call) ≈ **$3.00/month** after the renewable free monthly allowance is exhausted
- SEC API Pro **$49/month** with $10 included monthly credits, discounted overages, and the rest of the 39-family API surface
...
- **7-day free trial** on Pro and Pro+ Copilot tiers. SEC API does not offer
  a separate trial; every new organization receives a renewable monthly free
  allowance with hard caps.
