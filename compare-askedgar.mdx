...
pay-as-you-go only). SEC API is API-first: Sandbox, Pay as you go, or Custom.
There is no monthly minimum and no setup fee. Prepaid credits save 10–30%.

| Tier              | SEC API                                            | AskEdgar Copilot                       | AskEdgar API     |
| ----------------- | ----------------------------------------------- | -------------------------------------- | ---------------- |
| **Sandbox** | 100 included live calls each month; unlimited users       | Limited AI questions                   | None             |
| **Pay as you go** | From $0.01/call, prepaid wallet                                 | n/a                                    | $0.004–$0.019/KB |
| **Custom**    | Volume pricing, consolidated billing, TAM, SLA       | Custom                                 | Custom           |
...
- SEC API PAYG (300 × $0.01/call) ≈ **$3.00/month** after that month's included calls are used
- SEC API prepaid savings: pay $45 for $50 in credits (save 10%)

The PAYG arithmetic is the conversion lever for any agent at small-to-medium
volume. Custom is the path for volume pricing, consolidated billing, and a dedicated TAM.
...
- **7-day free trial** on Pro and Pro+ Copilot tiers. SEC API does not offer
  a separate trial; new organizations receive 100 included live calls
  each month, subject to hard caps.
...
| FinanceBench score                                      | 18 / 25 (72%) on a 25-question subset, 2026-04-25 | none published                    |
...
| FinanceBench                     | 18 / 25 (72%) on 25 questions, 2026-04-25 | not published                  |
...
*AskEdgar facts and numeric claims reflect data captured as of 2026-04-26. SEC API dilution-score and factor-exposure capabilities are described as of 2026-06-18.*
